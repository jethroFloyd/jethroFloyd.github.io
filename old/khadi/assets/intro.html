                ...
                <ul class="dropdown-menu">
                  <li><a href="../404.html">Pages</a>
                    <ul>  
                      ...
                      <li class="active"><a href="intro.html">Intro Page</a></li>
...
<div id="tm_intro-box">
  <div class="tm_inside">
    <div class="tm_inside2">
      <div class="fw_video"><div class="tm_iframe"><iframe width="460" height="264" src="http://www.youtube.com/embed/2kodXWejuy0?rel=0"></iframe></div></div>
      <div class="alignright"><a href="scaffolding.html" class="btn">skip intro</a></div>
    </div>
  </div>
</div>
