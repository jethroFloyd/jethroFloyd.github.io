...
RandomGenerator.prototype.fraction = function () {                                                                     // 132
  ...
  } else if (self.type === RandomGenerator.Type.NODE_CRYPTO) {                                                         // 136
    var numerator = parseInt(self.hexString(8), 16);                                                                   // 137
    return numerator * 2.3283064365386963e-10; // 2^-32                                                                // 138
  } else if (self.type === RandomGenerator.Type.BROWSER_CRYPTO) {                                                      // 139
...
Random.createWithSeeds = function () {                                                                                 // 255
  for (var _len = arguments.length, seeds = Array(_len), _key = 0; _key < _len; _key++) {                              // 255
